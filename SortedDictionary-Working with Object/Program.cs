...
class Program
{
    static void Main()
    {
        ...
        //Student newStudent = new Student(10423, "David", "English", 88.0);
        // studentDictionary.Add(newStudent.ID, newStudent);
        // Console.WriteLine("\nAfter adding David:");

        // Update a student's mark.
        // studentDictionary[10223].Mark = 90.5;
        // Console.WriteLine("\nAfter updating Bob's mark:");

        // Remove a student from the dictionary.
        // studentDictionary.Remove(10323);
        // Console.WriteLine("\nAfter removing Charlie:");

        // Display the final sorted list of students and their information.
       ...
       // }
        ...
        // or adapt the below
       // var result = from student in studentDictionary where student.Value.subject.Contains("Math") select student;
